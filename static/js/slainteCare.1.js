...
queue()
    .defer(d3.csv, "data/Figure-5.1-Public-Health-Service-Employment-by-grade-category-2007-to-2016.csv")
    .await(makeGraphs);
...
function makeGraphs(error, salaryData) {
    ...
    // makeBarChart(ndx, "Age Profile", "Year", "#age-profile", 350, 250);

    makeRowChart(ndx, 'Grade Category', "2016", '#phd-salary', 350, 250);
